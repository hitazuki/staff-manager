...
<body>
      ...
      if(!isset($_SESSION['userid'])){
        ...
        if(isset($_POST['submit']) && $_POST["submit"] == "修改"){
            ...
            else  
            {
			   ...
			   if($row['APASSWORD'] == $old){
				   $user_query = mysql_query("update administrator set APASSWORD=$new where A=$userid");
  ...
  <section class="about">
    <p class="about-links"><a href="../my1.php" target="_parent">返回</a></p>
  </section>
</body>
</html>