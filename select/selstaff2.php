...
<section class="container">
    <div class="page">
    <h1>职工查询</h1>
    <form method="post" action="selstaff2.php">
        <p>&nbsp;&nbsp;
      ...
      <p>&nbsp;&nbsp;
        ...
        <input type="submit" name="submit" value="按年龄查询">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <p>&nbsp;</p>
    </form>
    <?php
	  if(isset($_POST['submit']) && ($_POST["submit"] == "按ID查询"||"按年龄查询"))
	  {
	?>
    ...
    <?php
		 ...
		 $agemin = ' and 1=1';
		 $agemax = ' and 1=1';
		 if($_POST['submit'] == "按年龄查询") $order = " order by AGE";
		 ...
		 $result2 = mysql_query("SELECT * FROM staff where S=$userid");
		 $row2 = mysql_fetch_array($result2);
		 
		 $result = mysql_query("SELECT * FROM staff where ".$id.$name.$dep.$sex.$agemin.$agemax.$order);
